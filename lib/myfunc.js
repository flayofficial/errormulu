...
// exports serialize
exports.serialize = (flayatlantic, msg) => {
...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === flayatlantic.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = flayatlantic.user.id.split(':')[0]+'@s.whatsapp.net'
}
